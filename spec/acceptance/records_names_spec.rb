...
resource 'Records Names' do
  ...
  get '/records/names' do
    ...
    parameter :lt, 'Amount records names less than', scope: %i[record amount], type: :integer, example: 100
    parameter :gt, 'Amount records names greater than', scope: %i[record amount], type: :integer, example: -100
